...
export interface ValidatorInterface {
  ...
  validateBatches(workspaceRootPath: string): import('./types.js').ValidationResult;
...
export interface SessionToolContext {
  ...
  /** Absolute path to workspace folder (~/.datapilot/workspaces/{id}) */
   ...
   * - Claude: writes JSON files to ~/.datapilot/feedback/
