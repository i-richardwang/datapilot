...
export const RPC_CHANNELS = {
  ...
  sessions: {
    ...
    SHARE: 'sessions:share',
    SHARE_HTML: 'sessions:shareHtml',
  },
  transfer: {
  ...
  theme: {
    ...
    SET_OVERRIDE: 'theme:setOverride',
    RESET_OVERRIDE: 'theme:resetOverride',
  },
  system: {
  ...
  sources: {
    ...
    TEST: 'sources:test',
    INIT_GUIDE: 'sources:initGuide',
    INIT_PERMISSIONS: 'sources:initPermissions',
    AUTH_HELP: 'sources:authHelp',
  ...
  permissions: {
    ...
    GET: 'permissions:get',
    SET: 'permissions:set',
    ADD_MCP_PATTERN: 'permissions:addMcpPattern',
    ADD_API_ENDPOINT: 'permissions:addApiEndpoint',
    ADD_BASH_PATTERN: 'permissions:addBashPattern',
    ADD_WRITE_PATH: 'permissions:addWritePath',
  ...
  labels: {
    ...
    AUTO_RULE_LIST: 'labels:autoRuleList',
    AUTO_RULE_ADD: 'labels:autoRuleAdd',
    AUTO_RULE_REMOVE: 'labels:autoRuleRemove',
    AUTO_RULE_CLEAR: 'labels:autoRuleClear',
    AUTO_RULE_VALIDATE: 'labels:autoRuleValidate',
