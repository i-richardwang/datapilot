...
We take security seriously. If you discover a security vulnerability in DataPilot, please report it responsibly.

### How to Report

**Please do NOT report security vulnerabilities through public GitHub issues.**

Instead, please use [GitHub Security Advisories](https://github.com/i-richardwang/datapilot/security/advisories/new) for private disclosure.
...
- The `@craft-agent/*` workspace packages
- Official DataPilot repositories
