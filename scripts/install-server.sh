...
echo ""
echo "===================================="
echo "  DataPilot Server Ready"
echo "===================================="
echo ""
echo "Start the server (with Web UI):"
echo ""
echo "  DATAPILOT_SERVER_TOKEN=$TOKEN \\"
echo "  DATAPILOT_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  DATAPILOT_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
...
echo "  DATAPILOT_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  DATAPILOT_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  DATAPILOT_RPC_HOST=0.0.0.0 \\"
echo "  DATAPILOT_RPC_PORT=9100 \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
...
echo "  DATAPILOT_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  DATAPILOT_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  DATAPILOT_RPC_TLS_CERT=/path/to/cert.pem \\"
echo "  DATAPILOT_RPC_TLS_KEY=/path/to/key.pem \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
