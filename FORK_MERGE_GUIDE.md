...
>
> **Last updated after:** upstream v0.8.12 merge (2026-04-26) — GPT-5.5/DeepSeek providers, Pi SDK 0.70.2 uplift (tool registration shape contract restored, `customTools` + allowlist), composer attachment hybrid persistence, `getFilePath` preload
>
> 设计细节见专项文档：
