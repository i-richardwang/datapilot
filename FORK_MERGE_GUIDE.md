...
>
> **Last updated after:** upstream v0.8.11 merge (2026-04-23) — WhatsApp selfChatMode inbound gating, `call_llm` partial-output recovery, Pi co-author preference fix, follow-up quote full-length passthrough
>
> 设计细节见专项文档：
