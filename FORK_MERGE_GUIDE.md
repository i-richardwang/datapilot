...
>
> **Last updated after:** upstream v0.8.13 merge (2026-04-29) — per-action `thinkingLevel` overrides, `executePromptAutomation` options-object refactor, `sendMessage` `onAck` durability hook, queued-bubble inline chip (no shimmer), DeepSeek tool-call replay sanitizer
>
> 设计细节见专项文档：
