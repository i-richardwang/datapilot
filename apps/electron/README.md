# DataPilot Electron App

The primary desktop interface for DataPilot, built with Electron + React. Provides a multi-session inbox with chat interface for interacting with Claude via DataPilot workspaces.
