...
// Wire-format stability snapshot — manually curated, sorted ascending.
// Update only when intentionally adding/renaming an RPC channel; an unexpected
// diff means a wire-format break (clients on either side will see undefined).
const EXPECTED_CHANNELS: string[] = [
  ...
  'input:setSpellCheck',
  'labels:autoRuleAdd',
  'labels:autoRuleClear',
  'labels:autoRuleList',
  'labels:autoRuleRemove',
  'labels:autoRuleValidate',
  'labels:changed',
  'labels:create',
  'labels:delete',
  'labels:list',
  ...
  'permissions:addApiEndpoint',
  'permissions:addBashPattern',
  'permissions:addMcpPattern',
  'permissions:addWritePath',
