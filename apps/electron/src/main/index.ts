...
app.whenReady().then(async () => {
  ...
  // Seed tool icons to ~/.datapilot/tool-icons/ (copies bundled SVGs on first run)
  ensureToolIcons()

  // Seed preset themes to ~/.datapilot/themes/ (copies bundled theme JSONs on first run)
  ensurePresetThemes()
