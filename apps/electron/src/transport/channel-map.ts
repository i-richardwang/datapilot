...
export const CHANNEL_MAP = {
  ...
  listSessionsPage: invoke(RPC_CHANNELS.sessions.LIST_PAGE),
  getSidebarCounts: invoke(RPC_CHANNELS.sessions.SIDEBAR_COUNTS),
  getSessionMetas: invoke(RPC_CHANNELS.sessions.GET_METAS),
  ...
  // Automations
  listAutomations: invoke(RPC_CHANNELS.automations.LIST),
  ...
  getBatchStatus: invoke(RPC_CHANNELS.batches.GET_STATUS),
  ...
  retryFailedBatchItems: invoke(RPC_CHANNELS.batches.RETRY_FAILED),
