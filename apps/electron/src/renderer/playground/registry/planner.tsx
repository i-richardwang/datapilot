...
const projects: PlannerProject[] = [
  ...
  { id: 'p3', name: 'DataPilot App', status: 'open', sortOrder: 3, installationHint: 'Import mounted locally', memberCount: 4 },
...
const events: PlannerTaskEvent[] = [
  ...
  { id: 'e4', taskId: 't1', type: 'task.session_snapshot_updated', at: 'Today · 18:42', actor: 'DataPilot', payloadSummary: 'Refreshed snapshot summary' },
]
