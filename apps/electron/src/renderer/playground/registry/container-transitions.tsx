  ...
  return (
    <div className="w-full max-w-[920px] p-6 space-y-4">
      ...
      <div className="flex items-start gap-4">
        <div className="relative flex-1 rounded-xl border border-border/50 bg-foreground/2 p-5 min-h-[320px] overflow-hidden">
          <div className="absolute left-1/2 bottom-5 -translate-x-1/2">
            {isIslandMounted ? (
                ...
                <IslandContentView id="compact" anchorX="center" anchorY="bottom" morphFrom={morphFrom}>
                  <div className="p-1 flex items-center gap-1">
                    <button
                      ...
                      className={cn(
                        'h-[30px] px-2.5 rounded-md text-[13px] font-medium inline-flex items-center gap-1.5',
                  ...
                  <div className="w-[500px] p-3 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="h-7 w-7 inline-flex items-center justify-center rounded-md text-foreground/70 hover:bg-foreground/5 hover:text-foreground"
                        aria-label="Back"
                      >
                    ...
                    <div className="rounded-lg border border-border/70 bg-foreground/3 px-3 py-2">
                    ...
                    <div className="flex items-center gap-1 rounded-lg bg-foreground/3 p-1 w-fit">
                      <button
                        type="button"
                    ...
                    <div className="rounded-lg border border-border/70 px-3 py-2 bg-background shadow-minimal">
                      <input
                        value={note}
                    ...
                    <div className="flex justify-end gap-2 pt-1">
                      ...
                      <button
                        ...
                        className="h-8 px-3 rounded-lg text-sm bg-foreground text-background inline-flex items-center gap-1.5"
                      >
              ...
              <div className="min-w-[280px] rounded-xl border border-border/50 bg-background/80 px-4 py-3 text-xs text-foreground/65 text-center">
                Island cleared.
                <button
                  type="button"
      ...
      <div className="rounded-xl bg-foreground/3 border border-border/40 px-3 py-2 text-xs text-foreground/70">
