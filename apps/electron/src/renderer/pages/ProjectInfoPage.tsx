        ...
        <Info_Page.Content>
          ...
          {tab === 'assets' && (
            <Info_Section
              ...
              actions={
                <label
                  className="inline-flex items-center gap-1 h-7 px-3 text-xs font-medium rounded-lg bg-background shadow-minimal hover:bg-foreground/[0.03] transition-colors cursor-pointer"
                >
