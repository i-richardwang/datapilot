 ...
 * Shows both default patterns (from ~/.datapilot/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.datapilot/permissions/default.json.
...
/**
 * Build default permissions data from ~/.datapilot/permissions/default.json.
