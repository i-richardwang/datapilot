      ...
      <Drawer open={open} onOpenChange={(next) => { setOpen(next); if (next) checkRemoteHealth() }}>
        <DrawerTrigger asChild>
          <button
            ...
            className="titlebar-no-drag ml-1 h-9 flex-1 min-w-0 flex items-center justify-start gap-1 px-3 rounded-lg border border-foreground/6 text-sm text-foreground/55 hover:bg-foreground/5 hover:text-foreground transition-colors cursor-pointer data-[state=open]:bg-foreground/5 data-[state=open]:text-foreground"
          ...
          <div className="px-2 pb-2 flex flex-col gap-0.5 max-h-[60vh] overflow-y-auto">
                ...
                >
                  ...
                  {!isActive && (
                    <button
                      ...
                      className="shrink-0 h-9 w-9 rounded-lg flex items-center justify-center text-foreground/50 hover:text-destructive hover:bg-destructive/10 transition-colors"
                  ...
                  {!isActive && !disconnected && (
                    <button
                      ...
                      className="shrink-0 h-9 w-9 rounded-lg flex items-center justify-center text-foreground/50 hover:text-foreground hover:bg-foreground/10 transition-colors"
            ...
            <DrawerClose asChild>
              <button
                ...
                className="mt-1 flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-foreground/5 transition-colors text-left"
              >
