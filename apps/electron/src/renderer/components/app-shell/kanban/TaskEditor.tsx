    ...
    <div className="-ml-0.5 flex shrink-0 items-center">
      {display.map((node, i) => (
        <div
          key={i}
          className={cn(
            'relative flex h-5 w-5 items-center justify-center rounded-sm bg-background shadow-minimal',
            i > 0 && '-ml-1',
          )}
          style={{ zIndex: i + 1 }}
        >
      ...
      {remaining > 0 && (
        <div
          className="-ml-1 flex h-5 w-5 items-center justify-center rounded-sm bg-background text-[8px] font-medium text-muted-foreground shadow-minimal"
...
function SubtaskCard({
  ...
  return (
    <div className="group rounded-lg border border-border/70 bg-foreground/[0.015] p-3">
  ...
  return (
    <div className="flex h-full flex-col gap-3 bg-background p-3 text-foreground">
      ...
      <div className="flex items-center gap-2.5 rounded-xl border border-border bg-card px-3 py-2.5 shadow-minimal">
        ...
        {isEdit && (
          <div className="ml-3 inline-flex rounded-lg bg-foreground/[0.05] p-0.5">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-[minmax(360px,2fr)_3fr] gap-3">
        ...
        <div className="flex min-h-0 flex-col gap-4 overflow-y-auto rounded-xl border border-border bg-card p-4 shadow-minimal">
          ...
          <div className="inline-flex w-fit rounded-lg bg-foreground/[0.05] p-0.5">
        ...
        <div className="flex min-h-0 flex-col rounded-xl border border-border bg-card shadow-minimal">
          {mode === 'manual' ? (
            <>
              ...
              <div className="flex min-h-0 flex-1 flex-col gap-2.5 overflow-y-auto p-4">
                ...
                {subtasks.length === 0 && (
                  <button
                    onClick={addSubtask}
                    className="flex w-full items-center justify-center gap-1.5 rounded-lg border border-dashed border-border py-2.5 text-[12.5px] font-semibold text-foreground/40 transition-colors hover:border-foreground/30 hover:text-foreground/60"
                  >
            ...
            <div className="flex min-h-full flex-col gap-3 p-4">
              ...
              {[0, 1, 2].map((i) => (
                <div key={i} className="animate-pulse rounded-lg border border-border/70 bg-foreground/[0.015] p-3">
                  <div className="flex items-start gap-2">
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-3 overflow-y-auto rounded-xl border border-border bg-card p-4 shadow-minimal">
      {results.acceptanceCriteria && (
        <div className="rounded-lg border border-border/70 bg-foreground/[0.015] px-3 py-2.5">
      ...
      {results.nodes.map((node) => {
        ...
        return (
        <div key={node.id} className="rounded-lg border border-border/70 bg-foreground/[0.015] p-3">
          <div className="flex items-center gap-2">
