  ...
  const connectionsByProvider = React.useMemo(() => {
    ...
    for (const conn of llmConnections) {
      ...
      if (isAnthropicProvider(provider)) {
        ...
        groups['DataPilot Backend'].push(conn)
      }
    }
        ...
        <div className="relative">
          ...
          {isCollapsedInCompact ? (
            <button
              ...
              className="flex-1 h-7 mx-1 flex items-center justify-center text-foreground/30 hover:text-foreground/60 transition-colors cursor-pointer rounded-md hover:bg-foreground/5 focus:outline-none focus-visible:ring-1 focus-visible:ring-ring"
            >
              ...
              <TooltipTrigger asChild>
                <DropdownMenuTrigger asChild>
                  <button
                    type="button"
                    className={cn(
                      "input-toolbar-btn inline-flex items-center h-7 px-1.5 gap-0.5 text-[13px] shrink-0 rounded-md hover:bg-foreground/5 transition-colors select-none",
