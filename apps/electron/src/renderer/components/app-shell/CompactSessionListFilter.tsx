    ...
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="max-h-[75vh]">
        ...
        <div className="px-4 pb-2">
          <label className="bg-foreground/5 rounded-lg px-3 h-10 flex items-center gap-2">
            ...
            <div className="px-2 pt-2">
              <DrawerClose asChild>
                <button
                  ...
                  className="w-full flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-foreground/5 active:bg-foreground/10 transition-colors text-left"
                >
                  <Search className="h-4 w-4 text-muted-foreground shrink-0" />
    ...
    >
      ...
      {!pinned && mode && (
        <button
          ...
          className={cn(
            'shrink-0 h-7 px-2.5 rounded-md text-xs font-medium flex items-center gap-1 shadow-tinted',
            mode === 'include'
...
function PinnedChip({ icon, label }: { icon: React.ReactNode; label: React.ReactNode }) {
  return (
    <span className="inline-flex items-center gap-1.5 h-7 pl-2 pr-2.5 rounded-md bg-foreground/5 text-xs text-foreground/70">
