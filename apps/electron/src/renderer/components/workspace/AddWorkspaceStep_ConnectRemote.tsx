...
/**
 * AddWorkspaceStep_ConnectRemote - Connect to a remote DataPilot Server
 *
 * Two paths:
...
export function AddWorkspaceStep_ConnectRemote({
  ...
  const handleConnect = useCallback(async () => {
    ...
    if (!homeDir) return
    const defaultBasePath = `${homeDir}/.datapilot/workspaces`
    ...
    <AddWorkspaceContainer>
      ...
      <AddWorkspaceStepHeader
        ...
        description={isReconnectMode
          ...
          : "Connect to a remote DataPilot Server for this workspace."}
      />
