...
const MENU_ITEM_STYLE = 'flex cursor-pointer select-none items-center gap-3 rounded-md mx-1 px-2 py-1.5 text-[13px]'
const MENU_ITEM_SELECTED = 'bg-foreground/5'
// Type badge shown to the right of each item label (e.g. "Skill", "Source")
const MENU_TYPE_BADGE = 'rounded-sm shadow-minimal bg-background px-1.5 py-0.5 text-[10px] text-muted-foreground shrink-0'
