        ...
        <DrawerContent>
            ...
            <div className="px-4 pb-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-10 pr-3 rounded-xl bg-foreground/5 text-base outline-none focus:bg-foreground/[0.07] transition-colors"
                />
              </div>
            </div>
          )}
                ...
                return (
                  <DrawerClose asChild key={path}>
                    <button
                      ...
                      className={cn(
                        'flex items-center gap-3 px-3 py-3 rounded-xl text-left transition-colors hover:bg-foreground/5 group/row',
                      )}
                    >
                      <Icon_Folder className="h-5 w-5 shrink-0 text-foreground/60" />
                      <div className="flex-1 min-w-0">
                      ...
                      <button
                        ...
                        className="shrink-0 h-7 w-7 rounded-md flex items-center justify-center text-foreground/30 hover:text-foreground/70 hover:bg-foreground/5 transition-colors"
                      >
                        <X className="h-4 w-4" />
                      </button>
                    </button>
          ...
          <div className="px-2 pt-2 pb-4 border-t border-border/30 flex flex-col gap-1">
            <button
              ...
              className="w-full h-12 px-3 rounded-xl flex items-center gap-3 text-sm font-medium hover:bg-foreground/5 transition-colors"
            >
              <Icon_Folder className="h-5 w-5 shrink-0 text-foreground/60" />
            ...
            {showReset && (
              <button
                type="button"
                onClick={handleReset}
                className="w-full h-12 px-3 rounded-xl flex items-center gap-3 text-sm font-medium text-foreground/70 hover:bg-foreground/5 transition-colors"
              >
