  ...
  const innerContent = (
    <div className="relative group select-none pl-2 mr-2">
      ...
      <button
        ...
        className={cn(
          "entity-row-btn flex w-full items-start gap-2 pl-2 pr-4 py-3 text-left text-sm outline-none rounded-lg",
                  ...
                  >
                    {useCompactMenu ? (
                      <button
                        ...
                        className="p-1 rounded-md hover:bg-foreground/10 data-[state=open]:bg-foreground/10 cursor-pointer"
                      ...
                      <DropdownMenu modal={true} open={menuOpen} onOpenChange={setMenuOpen}>
                        <DropdownMenuTrigger asChild>
                          <div className="p-1 rounded-md hover:bg-foreground/10 data-[state=open]:bg-foreground/10 cursor-pointer">
