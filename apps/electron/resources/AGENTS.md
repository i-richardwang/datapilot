...
This folder contains assets that are bundled with the Electron app and synced to the user's `~/.datapilot/` directory on every launch.
...
|-------------|-----------|---------------|
| `docs/` | `~/.datapilot/docs/` | Always overwrite on launch |
| `themes/` | `~/.datapilot/themes/` | Always overwrite on launch |
| `permissions/` | `~/.datapilot/permissions/` | Always overwrite on launch |
| `tool-icons/` | `~/.datapilot/tool-icons/` | Always overwrite on launch |
| `release-notes/` | `~/.datapilot/release-notes/` | Always overwrite on launch |
| `config-defaults.json` | `~/.datapilot/config-defaults.json` | Always overwrite on launch |
