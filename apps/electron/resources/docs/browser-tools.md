...
Use `browser_tool` to control built-in browser windows (Chromium) inside DataPilot.
...
- Before first browser tool usage, the agent must read this guide (`~/.datapilot/docs/browser-tools.md`).
