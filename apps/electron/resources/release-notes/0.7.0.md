...
### Why it's cool
This is the first step toward full programmatic control of DataPilot. Script your agent workflows, integrate into CI/CD pipelines, or run sessions headlessly on remote machines. Partially addresses [#343](https://github.com/lukilabs/craft-agents-oss/issues/343).

## Headless Server

Run DataPilot as a standalone server without the Electron desktop app — deploy on any machine, connect from any client.
...
### Why it's cool
Deploy DataPilot on a remote server and connect from anywhere. Run it on your home lab, a cloud VM, or a CI runner. The thin-client mode means the browser UI stays lightweight while all the heavy lifting happens server-side. Partially addresses [#291](https://github.com/lukilabs/craft-agents-oss/issues/291).
