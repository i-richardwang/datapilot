...
echo "=== Building DataPilot AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: DataPilot-x86_64.AppImage or DataPilot-aarch64.AppImage
BUILT_APPIMAGE_NAME="DataPilot-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: DataPilot-x64.AppImage, DataPilot-arm64.AppImage
APPIMAGE_NAME="DataPilot-${ARCH}.AppImage"
