  ...
  actions: [
    {
      ...
      example: 'datapilot session list --sort recent --limit 20',
    },
    {
      name: 'get',
      ...
      flags: [],
      example: 'datapilot session get my-session-id',
    },
    {
      name: 'create',
      ...
      takesInput: true,
      example: 'datapilot session create --name "Triage" --input \'{"permissionMode":"safe"}\'',
    },
    {
      name: 'delete',
      ...
      positionals: [{ name: 'id', description: 'Session id' }],
      flags: [],
      example: 'datapilot session delete my-session-id',
    },
    {
      name: 'messages',
      ...
      positionals: [{ name: 'id', description: 'Session id' }],
      flags: [],
      example: 'datapilot session messages my-session-id',
    },
    {
      name: 'send',
      ...
      flags: [],
      takesInput: true,
      example: 'datapilot session send my-session-id "Summarize the latest"',
    },
    {
      name: 'cancel',
      ...
      positionals: [{ name: 'id', description: 'Session id' }],
      flags: [],
      example: 'datapilot session cancel my-session-id',
    },
    {
      name: 'share',
      ...
      example: 'datapilot session share my-session-id --html ./out.html --password secret',
    },
  ],
}
