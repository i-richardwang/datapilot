  ...
  actions: [
    {
      ...
      flags: [],
      example: 'datapilot automation list',
    },
    {
      name: 'get',
      ...
      flags: [],
      example: 'datapilot automation get my-matcher-id',
    },
    {
      name: 'create',
      ...
      takesInput: true,
      example: 'datapilot automation create --name "On new session" --event SessionCreated --input \'{"actions":[...]}\'',
    },
    {
      name: 'update',
      ...
      flags: [],
      takesInput: true,
      example: 'datapilot automation update my-matcher-id --input \'{"permissionMode":"safe"}\'',
    },
    {
      name: 'delete',
      ...
      positionals: [{ name: 'id', description: 'Automation matcher id' }],
      flags: [],
      example: 'datapilot automation delete my-matcher-id',
    },
    {
      name: 'enable',
      ...
      positionals: [{ name: 'id', description: 'Automation matcher id' }],
      flags: [],
      example: 'datapilot automation enable my-matcher-id',
    },
    {
      name: 'disable',
      ...
      positionals: [{ name: 'id', description: 'Automation matcher id' }],
      flags: [],
      example: 'datapilot automation disable my-matcher-id',
    },
    {
      name: 'history',
      ...
      example: 'datapilot automation history my-matcher-id --limit 20',
    },
    {
      name: 'test',
      ...
      positionals: [{ name: 'id', description: 'Automation matcher id' }],
      flags: [],
      example: 'datapilot automation test my-matcher-id',
    },
  ],
}
