...
export const STATUS_SPEC: EntitySpec = {
  ...
  actions: [
    ...
    },
    {
      ...
      flags: [],
      example: 'datapilot status get todo',
    },
    {
      name: 'create',
      ...
      takesInput: true,
      example: 'datapilot status create --name "In Progress" --category open --input \'{"color":"info"}\'',
    },
    {
      name: 'update',
      ...
      flags: [],
      takesInput: true,
      example: 'datapilot status update todo --input \'{"color":"warning"}\'',
    },
    {
      name: 'delete',
      ...
      positionals: [{ name: 'id', description: 'Status id' }],
      flags: [],
      example: 'datapilot status delete todo',
    },
    {
      name: 'reorder',
      ...
      example: 'datapilot status reorder --ids todo,in-progress,done',
    },
  ],
}
